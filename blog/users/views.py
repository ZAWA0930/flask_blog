...
from blog import db
from blog.models import User, BlogPost,BlogCategory
from blog.users.forms import RegistrationForm, LoginForm, UpdateUserForm
from blog.main.forms import BlogSearchForm
...
#     return render_template('users/user_list.html', blog_posts=blog_posts, recent_blog_posts=recent_blog_posts, blog_categories=blog_categories, form=form, searchtext=searchtext)
